...
def update_config(config, args):
    ...
    #JWR 4.11.2023
    config.TRAIN.DATA.EXP_DATA_NAME = config.CONFIG_EXP_NAME
    print(config.TRAIN.DATA.EXP_DATA_NAME)
    ...
    if not config.TEST.USE_LAST_EPOCH and config.VALID.DATA.DATASET is not None:
        ...
        #JWR 4.11.2023
        config.VALID.DATA.EXP_DATA_NAME = config.CONFIG_EXP_NAME
        print(config.VALID.DATA.EXP_DATA_NAME)
    ...
    #JWR 4.11.2023
    config.TEST.DATA.EXP_DATA_NAME = config.CONFIG_EXP_NAME
    print(config.TEST.DATA.EXP_DATA_NAME)
